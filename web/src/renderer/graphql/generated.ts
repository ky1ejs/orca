...
export type ProjectsQuery = {
  ...
  projects: Array<{
    ...
    createdAt: string;
    updatedAt: string;
    tasks: Array<{ __typename?: 'Task'; id: string; title: string; status: TaskStatus }>;
  }>;
};
...
export type TaskChangedSubscription = {
  __typename?: 'Subscription';
  taskChanged: {
    __typename?: 'Task';
    id: string;
...
export const TaskChangedDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'subscription',
      name: { kind: 'Name', value: 'TaskChanged' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<TaskChangedSubscription, TaskChangedSubscriptionVariables>;
